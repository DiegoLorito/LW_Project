...
namespace MK.Toon
{
    ...
    {        
        ...
        private void ColorProperty(MaterialProperty prop, bool showAlpha, bool hdrEnabled, GUIContent label)
        {
            ...
            Color c = EditorGUILayout.ColorField(label, prop.colorValue, false, true, hdrEnabled, colorPickerHDRConfig);
        ...
        override public void OnGUI(MaterialEditor materialEditor, MaterialProperty[] properties)
        {
            ...
            if (HandleBehavior("Main", ref showMainBehavior, materialEditor))
            {
                ...
                EditorGUI.BeginChangeCheck();
                ColorProperty(emissionColor, true, true, new GUIContent(emissionColor.displayName));
                if (showGIField)
