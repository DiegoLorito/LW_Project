...
public class ScreenSignIn : AppScreen
{
    ...
    public void SignIn(bool isPremiun)
    {
        ...
        routines.Add(RoutinesController.Action(()=> SaveClientDataOnJson(isPremiun)));
    ...
    private void SaveClientDataOnJson(bool isPremiun)
    {
        ...
        AppServerData.instance.dataClient.premiun = isPremiun;
